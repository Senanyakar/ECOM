        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Emlaklarimiz</h1>
              <span class="color-text-a">Emlaklar listeleri</span>
            </div>
          </div>
    ...
    <section class="property-grid grid">
      <div class="container">
        <div class="row">
          ...
          <a href="{{route('home_property_single',['id'=>$item->id])}}" class="col-md-4">
              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    ...
                    <i class="link-a">Click here to view
