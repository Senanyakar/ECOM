            ...
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="{{asset('assets')}}/#">Home</a>
                </li>
                <li class="breadcrumb-item">
                  <a href="{{asset('assets')}}/#">Agents</a>
                </li>
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="agent-avatar-box">
                  <img src="{{asset('assets')}}/img/agent-7.jpg" alt="" class="agent-avatar img-fluid">
                </div>
              </div>
                  ...
                  <div class="socials-footer">
                    <ul class="list-inline">
                      <li class="list-inline-item">
                        <a href="{{asset('assets')}}/#" class="link-one">
          ...
          <div class="row property-grid grid">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    ...
                    <div class="card-body-a">
                      ...
                      <a href="{{asset('assets')}}/#" class="link-a">Click here to view
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('assets')}}/img/property-8.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
