        ...
        <div class="card-body card-block">
            <form role="post" action="{{route('admin_property_store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="input" name="keywords" placeholder="keywords" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="input" name="location" placeholder="Location" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="input" name="sahibindenlink" placeholder="Location link" value="" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="input" name="locationlink" placeholder="Location link" class="form-control">
                        <small class="help-block form-text">Please enter a location make easier to find</small>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="input" name="area" placeholder="Area m3" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="input" name="baths" placeholder="baths" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" id="input" name="beds" placeholder="beds" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="input" name="garage" placeholder="garage" class="form-control">
